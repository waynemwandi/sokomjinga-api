...
def render_withdrawal_requested_email(user, withdrawal) -> str:
    amount_kes = withdrawal.amount_cents / 100

    content_html = f"""
    <div style="color:#a3a3a3; margin-bottom:24px;">
        We have received your withdrawal request. Our team will send it to your saved M-Pesa number after review.
    </div>
    ...
    <div>
        ...
        <span style="font-weight:700;">Status:</span> Pending
    </div>
    """
